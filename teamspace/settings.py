...
INSTALLED_APPS = [
    ...
    'core',
    'pages',
    # Move auth to the end for template loading reasons.
    # Really it just has to come after `core`, which is
    # where the password reset templates live.
    'django.contrib.auth',
]

EVIL = os.environ.get('EVIL', False)
if EVIL:
    INSTALLED_APPS += ['evil']
